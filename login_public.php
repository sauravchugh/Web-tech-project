...
if (isset($_POST["Submit"])) {
  ...
  if (empty($UserName)||empty($Password)) {
    ...
    $Found_Account=Login_Attempt_public($UserName,$Password);
    if ($Found_Account) {
      $_SESSION["UserId_P"]=$Found_Account["id"];
      $_SESSION["UserName_P"]=$Found_Account["username"];
      
      $_SESSION["succ_msg"]= "Wellcome ".$_SESSION["UserName_P"]."!";
    ...
    <div class="collapse navbar-collapse" id="navbarcollapseid">    
      <ul class="navbar-nav mr-auto"> <!-- mr margin right auto-->
           ...
           <li class="nav-item">
            ...
            <li  class="nav-item"><a style="color: red;" href="signup.php" class="nav-link"><b>Sign up</b></a></li>
        ...
        <div class="offset-sm-3 col-sm-6" style="min-height:500px;">
          ...
          <div class="card bg-secondary text-light">
            <div class="card-header">
              ...
              <form class="" action="login_public.php" method="post">
